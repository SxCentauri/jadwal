...
<head>
    ...
    <title>Dashboard Dosen - Sistem Penjadwalan Kuliah</title>
            ...
            <ul class="sidebar-menu">
                ...
                <li>
                    <a href="#" class="menu-item">
                        ...
                        <div class="menu-text">Jadwal Mengajar</div>
                        <div class="menu-badge">3</div>
                    </a>
                </li>

                <div class="menu-section">
                    <div class="section-title">Aktivitas Mengajar</div>
                </div>
                <li>
                    <a href="#" class="menu-item">
                        <div class="menu-icon">
        ...
        <main class="main-content">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-label">Kehadiran Kelas</div>
                </div>
            </div>
                    ...
                    <table class="schedule-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Selasa</td>
                                <td>08:50 - 10:30</td>
                                <td><span class="course-badge">Algoritma Pemrograman</span></td>
                                <td>TI-1B</td>
            ...
            <div class="content-section">
                ...
                <div class="actions-grid">
                    <a href="#" class="action-btn">
                        ...
                        <div class="action-label">Pra-Penjadwalan</div>
                        <div class="action-desc">Atur preferensi jadwal mengajar</div>
                    </a>
                    <a href="#" class="action-btn">
                        <div class="action-icon">
                            <i class="fas fa-calendar-plus"></i>
                        </div>
                        <div class="action-label">Lihat Jadwal</div>
                        <div class="action-desc">Lihat jadwal mengajar lengkap</div>
                    </a>
                    <a href="#" class="action-btn">
                        <div class="action-icon">
                            <i class="fas fa-book-open"></i>
                        </div>
                        <div class="action-label">Materi Kuliah</div>
                        <div class="action-desc">Kelola materi pembelajaran</div>
                    </a>
                    <a href="#" class="action-btn">
                        <div class="action-icon">
                            <i class="fas fa-tasks"></i>
                        </div>
                        <div class="action-label">Tugas & Quiz</div>
                        <div class="action-desc">Buat tugas dan quiz</div>
                    </a>
                </div>
            </div>
        </main>
