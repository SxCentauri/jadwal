...
<head>
    ...
    <title>Tambah Penugasan Mengajar - Admin</title>
    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <div class="welcome-banner">
                ...
                <div class="welcome-text">Buat penugasan baru yang akan diolah oleh AI generator.</div>
            </div>
            ...
            <div class="form-container">
                <form action="{{ route('admin.penugasan.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="sks" name="sks" class="form-control @error('sks') is-invalid @enderror" value="{{ old('sks') }}" min="1" max="10" required>
                        @error('sks')
                            <div class="invalid-feedback"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="kelas" name="kelas" class="form-control @error('kelas') is-invalid @enderror" value="{{ old('kelas') }}" placeholder="Contoh: TI-3A" required>
                        @error('kelas')
                            <div class="invalid-feedback"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="time_block" name="time_block" class="form-control @error('time_block') is-invalid @enderror" required>
                            <option value="full" {{ old('time_block') == 'full' ? 'selected' : '' }}>Full Semester</option>
                            <option value="pra-uts" {{ old('time_block') == 'pra-uts' ? 'selected' : '' }}>Pra-UTS</option>
                            <option value="pasca-uts" {{ old('time_block') == 'pasca-uts' ? 'selected' : '' }}>Pasca-UTS</option>
                        </select>
                        @error('time_block')
                            <div class="invalid-feedback"><i class="fas fa-exclamation-circle"></i> {{ $message }}</div>
                        @enderror
