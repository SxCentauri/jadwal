...
<head>
    ...
    <title>Manajemen Penugasan Mengajar - Admin</title>
...
<body>
    ...
    <div class="confirmation-modal" id="deleteModal">
        <div class="modal-content">
            ...
            <p class="modal-message" id="modalMessage">Apakah Anda yakin ingin menghapus data penugasan ini? Tindakan ini tidak dapat dibatalkan.</p>
    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            ...
            <div class="welcome-banner">
                ...
                <div class="welcome-text">Kelola penugasan mengajar dosen dan mata kuliah</div>
            </div>
            ...
            <div class="content-section">
                <div class="section-header">
                    ...
                    <a href="{{ route('admin.penugasan.create') }}" class="btn-primary">
                    ...
                    <table class="data-table">
                        ...
                        <tbody>
                            @forelse ($penugasan as $item)
                                <tr>
                                    <td>{{ $item->mataKuliah->nama_mata_kuliah ?? 'N/A' }}</td>
                                    <td>{{ $item->sks }}</td>
                                    <td>{{ $item->kelas }}</td>
                                    <td style="text-transform: capitalize;">{{ $item->semester }}</td>
                                    <td>{{ $item->dosen->name ?? 'N/A' }}</td>
                                    <td>
                                        @if($item->time_block == 'full')
                                            <span class="badge badge-full">Full Semester</span>
                                        @elseif($item->time_block == 'pra-uts')
                                            <span class="badge badge-pra">Pra-UTS</span>
                                        @elseif($item->time_block == 'pasca-uts')
                                            <span class="badge badge-pasca">Pasca-UTS</span>
                                        @endif
                                    </td>
                                    <td class="action-buttons">
                                        <a href="{{ route('admin.penugasan.edit', $item->id) }}" class="btn-edit">
                                            <i class="fas fa-edit"></i>
                                            Edit
                                        </a>
                                        <button type="button" class="btn-delete" onclick="showDeleteConfirmation('{{ $item->mataKuliah->nama_mata_kuliah ?? 'Penugasan' }} ({{ $item->kelas }})', '{{ route('admin.penugasan.destroy', $item->id) }}')">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="empty-state">
                                        <i class="fas fa-calendar-alt"></i>
                                        <div>Belum ada data penugasan mengajar</div>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
    ...
    <script>
        ...
        function showDeleteConfirmation(assignmentName, deleteUrl) {
            const modal = document.getElementById('deleteModal');
            const modalMessage = document.getElementById('modalMessage');

            // Set pesan konfirmasi
            modalMessage.textContent = `Apakah Anda yakin ingin menghapus penugasan "${assignmentName}"? Tindakan ini tidak dapat dibatalkan.`;

            // Simpan URL delete untuk digunakan nanti
            currentDeleteForm = deleteUrl;
