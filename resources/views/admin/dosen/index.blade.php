...
<body>
    ...
    <div class="confirmation-modal" id="deleteModal">
        <div class="modal-content">
            ...
            <p class="modal-message" id="modalMessage">Apakah Anda yakin ingin menghapus data dosen ini? Tindakan ini tidak dapat dibatalkan.</p>
    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            <div class="welcome-banner">
                ...
                <div class="welcome-text">Kelola data dosen dan informasi pengajar</div>
            </div>
                            ...
                            @forelse ($dosens as $dosen)
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        ...
                                        <button type="button" class="btn-delete" onclick="showDeleteConfirmation('{{ $dosen->name }}', '{{ route('admin.dosen.destroy', $dosen->id) }}')">
    ...
    <script>
        ...
        function showDeleteConfirmation(dosenName, deleteUrl) {
            const modal = document.getElementById('deleteModal');
            const modalMessage = document.getElementById('modalMessage');

            // Set pesan konfirmasi
            modalMessage.textContent = `Apakah Anda yakin ingin menghapus data dosen "${dosenName}"? Tindakan ini tidak dapat dibatalkan.`;
